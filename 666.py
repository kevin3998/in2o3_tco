...
if __name__ == "__main__":
    ...
    # Pycharm run example:
    SCRIPT_INPUT_FILE = "data/extracted_json/json_load_directly/structured_extraction_jsonload.json"
    SCRIPT_OUTPUT_FILE = "data/extracted_json/json_load_directly/material_data_only.json"
